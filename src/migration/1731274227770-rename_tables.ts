...
export class RenameTables1731274227770 implements MigrationInterface {
    name = 'RenameTables1731274227770';
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.renameTable('refreshTokens', 'refresh_tokens');
    }
}
